...
export default function PeakPackAd_1200_1200_budget_explorer_es_MX() {
  return (
    <div className="relative size-full" data-name="1200x1200_budget_explorer_es_MX.png" data-variant="budget_explorer-es-MX-1200x1200">
      ...
      <div className="absolute contents inset-[19.75%_30.08%_27.87%_4%]" data-name="Content">
        <div className="absolute font-['Inter:Bold_Italic',_sans-serif] font-bold inset-[19.75%_42.5%_69.43%_4%] italic leading-[0] text-[46px] text-gray-50 text-left text-nowrap">
          <p className="block leading-[normal] whitespace-pre">Smart Value. Big Adventures.</p>
        </div>
        
        <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[39.49%_30.08%_56.21%_4%] leading-[0] not-italic text-[18px] text-gray-200 text-left text-nowrap">
        ...
        <div className="absolute contents inset-[49.36%_81.83%_44.9%_4%]" data-name="Badges">
          ...
          <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[50.64%_82.83%_46.34%_5.67%] leading-[0] not-italic text-[14px] text-gray-300 text-left text-nowrap">
        ...
        <div className="absolute contents inset-[60.51%_76%_30.57%_4%]" data-name="CTA">
          ...
          <div className="absolute font-['Inter:Bold_Italic',_sans-serif] font-bold inset-[63.06%_81.96%_33.12%_9.96%] italic leading-[0] text-[18px] text-center text-gray-900 text-nowrap">
        ...
        <div className="absolute contents inset-[57.33%_69.42%_38.85%_26.5%]" data-name="Price">
          <div className="absolute font-['Inter:Bold_Italic',_sans-serif] font-bold inset-[57.33%_69.42%_38.85%_26.5%] italic leading-[0] text-[18px] text-gray-50 text-left text-nowrap">
        ...
        <div className="absolute contents inset-[69.75%_73%_27.87%_4%]" data-name="Legal">
          <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[69.75%_73%_27.87%_4%] leading-[0] not-italic text-[10px] text-gray-400 text-left text-nowrap">
      ...
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[95.54%_4%_2.07%_76.92%] leading-[0] not-italic text-[12px] text-gray-500 text-nowrap text-right">
        <p className="block leading-[normal] whitespace-pre">1200x1200 budget explorer • es-MX</p>
      </div>
    </div>
  );
}