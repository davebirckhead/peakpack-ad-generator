...
export default function PeakPackAd_1200_628_budget_explorer_es_MX() {
  return (
    <div className="relative size-full" data-name="1200x628_budget_explorer_es_MX.png" data-variant="budget_explorer-es-MX-1200x628">
      ...
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[95.54%_4%_2.07%_76.92%] leading-[0] not-italic text-[12px] text-gray-500 text-nowrap text-right">
        <p className="block leading-[normal] whitespace-pre">1200x628 budget explorer • es-MX</p>
      </div>
    </div>
  );
}