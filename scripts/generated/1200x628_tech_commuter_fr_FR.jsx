...
export default function PeakPackAd_1200_628_tech_commuter_fr_FR() {
  return (
    <div className="relative size-full" data-name="1200x628_tech_commuter_fr_FR.png" data-variant="tech_commuter-fr-FR-1200x628">
      ...
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal inset-[95.54%_4%_2.07%_76.92%] leading-[0] not-italic text-[12px] text-gray-500 text-nowrap text-right">
        <p className="block leading-[normal] whitespace-pre">1200x628 tech commuter • fr-FR</p>
      </div>
    </div>
  );
}